    ...
    <div>
      ...
      >
        <div
          ...
          :key="image.alt"
          class="mx-[1em] mt-[2em] w-[38%] border-[0.3em] border-white-pastel-light bg-white-default outline outline-[0.01px] outline-[#dddcdc] project-img:mx-0 project-img:w-[100%]"
        >
