<template>
  <div
    id="HOME"
    class="animate__animated animate__fadeInUp m-auto flex w-[21.5em] flex-col justify-between py-[3em] pb-0 pt-[5em] text-[1.12em] text-brown-pastel-dark md:flex-row md:pt-[8em]"
  >
    <img
